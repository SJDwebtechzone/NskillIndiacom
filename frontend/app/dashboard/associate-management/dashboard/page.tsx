...
export default function AssociateDashboard() {
    ...
    return (
        <div className="space-y-8 pb-12">
            {/* Welcome Header */}
            <div className="relative p-10 bg-gradient-to-br from-[#1e3a8a] via-[#1d4ed8] to-[#2563eb] rounded-[3rem] text-white overflow-hidden shadow-2xl">
                ...
                <div className="absolute top-0 right-0 w-80 h-80 bg-blue-400/20 rounded-full -translate-y-1/2 translate-x-1/2 blur-3xl"></div>
                <div className="absolute bottom-0 left-0 w-40 h-40 bg-blue-300/10 rounded-full translate-y-1/2 -translate-x-1/2 blur-2xl"></div>
            </div>
                ...
                <div className="bg-white p-8 rounded-[2.5rem] shadow-xl border border-slate-100 flex flex-col justify-between">
                    <div>
                        <h3 className="text-xl font-black text-slate-800 mb-4 flex items-center gap-2">
                             <TrendingUp className="text-blue-600" /> Performance Overview
                        </h3>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-8 mt-4">
                        ...
                        <table className="w-full text-left border-collapse">
                            ...
                            <tbody>
                                {stats.recentEnquiries.length === 0 ? (
                                    ...
                                    <tr key={enq.id} className="border-b border-slate-50 hover:bg-blue-50/30 transition-all group">
                ...
                <div className="bg-white rounded-[2.5rem] shadow-xl border border-slate-100 overflow-hidden">
                    <div className="p-8 border-b border-slate-50 flex justify-between items-center">
                        <h3 className="text-xl font-black text-slate-800 flex items-center gap-2">
                            <CheckCircle2 className="text-blue-600" /> Recent Admissions
                        </h3>
                        <Link href="/dashboard/associate-management/admission" className="text-xs font-bold text-blue-600 hover:underline">View All</Link>
                    </div>
                    <div className="max-h-[350px] overflow-y-auto custom-scrollbar">
                        <table className="w-full text-left border-collapse">
                            <thead className="bg-slate-50/50 sticky top-0 z-10 backdrop-blur-md">
                        ...
                        >
                            ...
                            <div className="p-10 max-h-[85vh] overflow-y-auto custom-dashboard-modal-scroll">
                                <div className="flex items-center gap-6 mb-10 pb-6 border-b border-slate-100">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex items-center gap-3 mt-1">
                                            <span className={`px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-[0.15em] ${viewType === 'enquiry' ? 'bg-blue-50 text-blue-600' : 'bg-blue-100 text-blue-700'}`}>
                                ...
                                <div className="mt-12 flex justify-center">
                                    <button 
                                        onClick={() => { setSelectedItem(null); setViewType(null); }}
                                        className="w-full py-4 bg-blue-600 text-white rounded-2xl font-black uppercase text-[10px] tracking-widest hover:bg-blue-700 transition-all shadow-lg"
                                    >
                                        Close Quick View
                                    </button>
                                </div>
