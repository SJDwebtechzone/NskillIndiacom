...
export default function TrainerPostTestPage() {
    ...
    const fetchCourses = async () => {
      try {
        ...
        const res = await fetch(
          `${process.env.NEXT_PUBLIC_API_URL}/api/admin/finaltest/trainer/courses`,
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-800">Post-Test Management</h1>
        <p className="text-gray-500 text-sm mt-1">
          Select a course to manage its post-test questions or view student attempts
        </p>
      </div>
            ...
            >
              ...
              <div className="flex gap-2">
                <button
                  onClick={() =>
                    router.push(
                      `/dashboard/trainer-management/post-test/${encodeURIComponent(course.course_name)}/post-test`
                    )
                  }
                ...
                <button
                  onClick={() =>
                    router.push(
                      `/dashboard/trainer-management/post-test/${encodeURIComponent(course.course_name)}/attempts`
                    )
                  }
