  ...
  return (
    <div style={{ minHeight: "100vh", background: "#f8fafc" }}>
      <div style={{
        ...
        <h1 style={{ fontSize: "1.1rem", fontWeight: 800, color: "#2563eb", margin: 0 }}>
          NTSC — Associate Registration
        </h1>
        <p style={{ fontSize: "0.73rem", color: "#94a3b8", marginTop: 4, marginBottom: 0 }}>
          Fill in all steps and submit your application
      ...
      {showSuccess && (
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              background: "#dbeafe", borderRadius: 12, padding: "10px 20px",
              color: "#1d4ed8", fontWeight: 700, fontSize: "0.84rem", marginBottom: 28
            }}>
              ⏳ Status: Pending Review
            </div>
            <button
