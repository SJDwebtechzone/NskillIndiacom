    ...
    <div className="bg-gray-50 min-h-screen">
        ...
        <div className="relative z-10 px-6 md:px-12 max-w-7xl mx-auto w-full flex justify-start">
          <div className="max-w-xl text-left">
            ...
            <motion.h1
              ...
              className="text-black text-5xl md:text-6xl font-black mb-4 uppercase tracking-tight"
            >
              Shape Your Future
            </motion.h1>
            <motion.p
              ...
              className="text-slate-600 text-lg md:text-xl font-bold mb-8"
            >
            ...
            <motion.button
              ...
              className="bg-[#2563eb] hover:bg-[#1d4ed8] text-white px-8 py-3.5 rounded-full font-bold text-lg transition-all shadow-lg hover:shadow-xl active:scale-95"
            >
      ...
      <div className="max-w-7xl mx-auto px-6 py-20">
        ...
        <div className="mt-20 bg-blue-600 rounded-3xl p-10 md:p-16 flex flex-col md:flex-row items-center justify-between shadow-2xl overflow-hidden relative">
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center gap-8 w-full md:w-auto mt-8 md:mt-0">
            {/* QR Code */}
            <div className="flex items-center gap-4 bg-white/10 p-4 rounded-2xl border border-white/20 backdrop-blur-sm w-full md:w-auto">
              ...
              <div className="text-left">
                ...
                <p className="text-[12px] text-blue-100 leading-tight">Scan this QR to view<br />jobs curated for you</p>
              </div>
            </div>
